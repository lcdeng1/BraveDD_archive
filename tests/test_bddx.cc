...
bool buildSetForest(uint16_t num, PredefForest bdd)
{
    ...
    // I'm keeping this loop for now so we can use them once we have parser for bddx
    // That way we can have "actual" tests
...
int main()
{
    // TODO: once we have a parser for bddx we can actuallly write the test
    // For now, I'll print some functions and compare them

    std::cout << "Printing QBDD..." << std::endl;
    buildSetForest(4,PredefForest::QBDD);
    std::cout << "Printing FBDD..." << std::endl;
    buildSetForest(4,PredefForest::FBDD);
    std::cout << "Printing ESRBDD..." << std::endl;
    buildSetForest(4,PredefForest::ESRBDD);
    std::cout << "Printing RexBDD..." << std::endl;
    buildSetForest(4,PredefForest::REXBDD);
    std::cout << "Printing QBMxD..." << std::endl;
    buildRelForest(2,PredefForest::QBMXD);
    std::cout << "Printing FBMxD..." << std::endl;
    buildRelForest(2,PredefForest::FBMXD);
    std::cout << "Printing IBMxD..." << std::endl;
    buildRelForest(2,PredefForest::IBMXD);
    std::cout << "Printing ESRMxD..." << std::endl;
    buildRelForest(2,PredefForest::ESRBMXD);
}